...
-- The noremap command is used to create a non-recursive key mapping, which means that the mapping will not be expanded further if it contains another key mapping.
...
keymap("n", "<leader>d", ":bdelete<CR>:NvimTreeClose<CR>", opts)
